...
LINKEDIN_CONSUMER_KEY = os.getenv('LINKEDIN_CONSUMER_KEY')
LINKEDIN_CONSUMER_SECRET = os.getenv('LINKEDIN_CONSUMER_SECRET')
...
INTERCOM_API_SECRET = os.getenv('INTERCOM_API_SECRET')
