...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClientContactsList'
        db.create_table('client_clientcontactslist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('data', self.gf('jsonfield.fields.JSONField')(null=True, blank=True)),
        ))
        db.send_create_signal('client', ['ClientContactsList'])


    def backwards(self, orm):
        # Deleting model 'ClientContactsList'
        db.delete_table('client_clientcontactslist')
    ...
    models = {
        ...
        'client.clientcontactslist': {
            'Meta': {'object_name': 'ClientContactsList'},
