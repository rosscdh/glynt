...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientProfile.is_lawyer'
        db.add_column(u'client_clientprofile', 'is_lawyer',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClientProfile.is_lawyer'
        db.delete_column(u'client_clientprofile', 'is_lawyer')
