...
$(function() {
    ...
    $.widget( "django.fluent_comments", {
        ...
        options: {
            ...
            'debug': true,
            'comment_waiting': $('#comment-waiting'),
...
//             $(document).on( 'click', '.comment-reply-link', showThreadedReplyForm);
//             $(document).on( 'click', '.comment-cancel-reply-link', cancelThreadedReplyForm);
