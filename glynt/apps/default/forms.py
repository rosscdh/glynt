...
class WillStep7(forms.Form):
    ...
    shareholder_address = forms.CharField(max_length=255,widget=forms.Textarea(attrs={'placeholder':'Shareholder Address','class':'md-updater','data-hb-name':'shareholder_address'}))
