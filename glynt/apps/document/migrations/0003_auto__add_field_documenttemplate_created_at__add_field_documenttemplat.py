...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentTemplate.created_at'
        db.add_column('document_documenttemplate', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 2, 24, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'DocumentTemplate.last_modified'
        db.add_column('document_documenttemplate', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.datetime(2013, 2, 24, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentTemplate.created_at'
        db.delete_column('document_documenttemplate', 'created_at')

        # Deleting field 'DocumentTemplate.last_modified'
        db.delete_column('document_documenttemplate', 'last_modified')
