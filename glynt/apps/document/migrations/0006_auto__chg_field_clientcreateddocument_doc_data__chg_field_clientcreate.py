...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClientCreatedDocument.doc_data'
        db.alter_column('document_clientcreateddocument', 'data', self.gf('jsonfield.fields.JSONField')(default='', db_column='data'))

        # Changing field 'ClientCreatedDocument.meta_data'
        db.alter_column('document_clientcreateddocument', 'meta_data', self.gf('jsonfield.fields.JSONField')())

    def backwards(self, orm):

        # Changing field 'ClientCreatedDocument.doc_data'
        db.alter_column('document_clientcreateddocument', 'data', self.gf('jsonfield.fields.JSONField')(null=True, db_column='data'))

        # Changing field 'ClientCreatedDocument.meta_data'
        db.alter_column('document_clientcreateddocument', 'meta_data', self.gf('jsonfield.fields.JSONField')(null=True))
