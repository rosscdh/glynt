...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClientCreatedDocument.slug'
        db.alter_column('document_clientcreateddocument', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255, null=True))

        # Changing field 'Document.slug'
        db.alter_column('document_document', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'ClientCreatedDocument.slug'
        db.alter_column('document_clientcreateddocument', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))

        # Changing field 'Document.slug'
        db.alter_column('document_document', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
