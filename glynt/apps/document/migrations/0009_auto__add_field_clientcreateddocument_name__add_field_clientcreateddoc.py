...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientCreatedDocument.name'
        db.add_column('document_clientcreateddocument', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ClientCreatedDocument.slug'
        db.add_column('document_clientcreateddocument', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClientCreatedDocument.name'
        db.delete_column('document_clientcreateddocument', 'name')

        # Deleting field 'ClientCreatedDocument.slug'
        db.delete_column('document_clientcreateddocument', 'slug')
    ...
    models = {
        ...
        'document.clientcreateddocument': {
            'Meta': {'object_name': 'ClientCreatedDocument'},
