...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ClientCreatedDocument.data'
        db.delete_column('document_clientcreateddocument', 'data')

        # Adding field 'ClientCreatedDocument.doc_data'
        db.add_column('document_clientcreateddocument', 'doc_data',
                      self.gf('jsonfield.fields.JSONField')(null=True, db_column='data', blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'ClientCreatedDocument.data'
        db.add_column('document_clientcreateddocument', 'data',
                      self.gf('jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ClientCreatedDocument.doc_data'
        db.delete_column('document_clientcreateddocument', 'data')
