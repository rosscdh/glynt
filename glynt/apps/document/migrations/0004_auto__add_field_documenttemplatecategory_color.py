...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentTemplateCategory.color'
        db.add_column('document_documenttemplatecategory', 'color',
                      self.gf('django.db.models.fields.CharField')(max_length=24, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentTemplateCategory.color'
        db.delete_column('document_documenttemplatecategory', 'color')
