...
from glynt.apps.document.views import ClientCreatedDocumentSaveProgressView, PersistClientCreatedDocumentProgressView 
...
urlpatterns = patterns('',
    ...
    url(r'^(?P<slug>.+)/save/$', ClientCreatedDocumentSaveProgressView.as_view(), name='save_progress'),
