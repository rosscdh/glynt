...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FlyForm.document'
        db.add_column('flyform_flyform', 'document',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='fly_document', null=True, to=orm['document.Document']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'FlyForm.document'
        db.delete_column('flyform_flyform', 'document_id')
    ...
    models = {
        ...
        'document.document': {
            ...
            'flyform': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'fly_form'", 'unique': 'True', 'to': "orm['flyform.FlyForm']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'flyform.flyform': {
            ...
            'document': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'fly_document'", 'null': 'True', 'to': "orm['document.Document']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'taggit.tag': {
    ...
    complete_apps = ['flyform', 'document']