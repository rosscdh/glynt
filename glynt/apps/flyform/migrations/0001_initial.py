...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('flyform_flyform', (
            ...
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['document.DocumentTemplate'], null=True, blank=True)),
            ('body', self.gf('jsonfield.fields.JSONField')()),
            ('defaults', self.gf('jsonfield.fields.JSONField')(null=True, blank=True)),
        ))
    ...
    models = {
        ...
        'flyform.flyform': {
            ...
            'document': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['document.DocumentTemplate']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        }
    }
