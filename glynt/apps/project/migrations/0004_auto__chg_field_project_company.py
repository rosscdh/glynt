...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'project_project', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['company.Company'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Project.company'
        db.alter_column(u'project_project', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['company.Company']))
    ...
    models = {
        ...
        u'project.project': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['company.Company']", 'null': 'True'}),
