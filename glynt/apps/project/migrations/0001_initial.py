...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field transactions on 'Project'
        m2m_table_name = db.shorten_name(u'project_project_transactions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm[u'project.project'], null=False)),
            ('transaction', models.ForeignKey(orm[u'transact.transaction'], null=False))
        ))
        db.create_unique(m2m_table_name, ['project_id', 'transaction_id'])

        # Adding model 'ProjectLawyer'
        db.create_table('project_project_lawyer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'project', ['ProjectLawyer'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field transactions on 'Project'
        db.delete_table(db.shorten_name(u'project_project_transactions'))

        # Deleting model 'ProjectLawyer'
        db.delete_table('project_project_lawyer')
