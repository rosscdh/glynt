...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """
        Get the customer user and lawyer users into a list
        and make them the participants
        """
        for project in orm['project.Project'].objects.all():
            participants = [project.customer.user] + [lawyer.user for lawyer in project.lawyers.all()]
