...
from .views import (ToDoDetailView, ToDoDiscussionView, ToDoEditView, ToDoAttachmentView, ToDoAssignView,)


urlpatterns = patterns('',
    url(r'^(?P<project_uuid>.+)/(?P<slug>.+)/discussion/$', login_required(ToDoDiscussionView.as_view()), name='discussion'),
