...
class SignDocumentView(UpdateView):
    ...
    def get_object(self, queryset=None):
        ...
        if pk is not None:
            return get_object_or_404(self.model.objects.select_related('document', 'document__source_document'), document=pk, key_hash=self.kwargs['hash'])
        else:
    ...
    def get_context_data(self, **kwargs):
        ...
        context['document_html'] = self.object.document.documenthtml_set.all()[0].render()
