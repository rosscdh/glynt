...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('sign_documentsignature', 'date_signed', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'DocumentSignature.date_signed'
        db.alter_column('sign_documentsignature', 'date_signed', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 9, 11, 0, 0)))
    ...
    models = {
        ...
        'sign.documentsignature': {
            ...
            'date_signed': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
