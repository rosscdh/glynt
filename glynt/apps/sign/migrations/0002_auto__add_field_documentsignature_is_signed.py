...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentSignature.is_signed'
        db.add_column('sign_documentsignature', 'is_signed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentSignature.is_signed'
        db.delete_column('sign_documentsignature', 'is_signed')
