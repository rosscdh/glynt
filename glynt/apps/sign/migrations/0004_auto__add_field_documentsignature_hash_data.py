...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentSignature.hash_data'
        db.add_column('sign_documentsignature', 'hash_data',
                      self.gf('django.db.models.fields.CharField')(default=123, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentSignature.hash_data'
        db.delete_column('sign_documentsignature', 'hash_data')
