...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentSignature.key_hash'
        db.add_column('sign_documentsignature', 'key_hash',
                      self.gf('django.db.models.fields.CharField')(default=1234, unique=True, max_length=32),
                      keep_default=False)


        # Changing field 'DocumentSignature.user'
        db.alter_column('sign_documentsignature', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):
        # Deleting field 'DocumentSignature.key_hash'
        db.delete_column('sign_documentsignature', 'key_hash')


        # Changing field 'DocumentSignature.user'
        db.alter_column('sign_documentsignature', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))
