...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentSignature.date_invited'
        db.add_column('sign_documentsignature', 'date_invited',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 9, 11, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'DocumentSignature.date_signed'
        db.alter_column('sign_documentsignature', 'date_signed', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'DocumentSignature.date_invited'
        db.delete_column('sign_documentsignature', 'date_invited')


        # Changing field 'DocumentSignature.date_signed'
        db.alter_column('sign_documentsignature', 'date_signed', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
