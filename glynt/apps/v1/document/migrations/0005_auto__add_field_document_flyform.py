...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('document_document', 'flyform',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['flyform.FlyForm']),
                      keep_default=False)
    ...
    models = {
        ...
        'document.document': {
            ...
            'flyform': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['flyform.FlyForm']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
