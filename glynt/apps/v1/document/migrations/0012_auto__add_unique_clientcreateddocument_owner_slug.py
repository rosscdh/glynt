...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ClientCreatedDocument', fields ['owner', 'slug']
        db.create_unique('document_clientcreateddocument', ['owner_id', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'ClientCreatedDocument', fields ['owner', 'slug']
        db.delete_unique('document_clientcreateddocument', ['owner_id', 'slug'])
