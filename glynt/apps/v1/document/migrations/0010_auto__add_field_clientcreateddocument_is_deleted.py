...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientCreatedDocument.is_deleted'
        db.add_column('document_clientcreateddocument', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClientCreatedDocument.is_deleted'
        db.delete_column('document_clientcreateddocument', 'is_deleted')
