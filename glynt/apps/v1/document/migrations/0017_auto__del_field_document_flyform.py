...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Document.flyform'
        raise RuntimeError("Cannot reverse this migration. 'Document.flyform' and its values cannot be restored.")
