...
ROOT_GLYNT_DIR = os.path.dirname(os.path.realpath(FEATURE_DIR + '/../'))

sys.path.append(ROOT_GLYNT_DIR)
sys.path.append(ROOT_GLYNT_DIR + '/glynt/')

site.addsitedir(ROOT_GLYNT_DIR)
site.addsitedir(ROOT_GLYNT_DIR + '/glynt/')
